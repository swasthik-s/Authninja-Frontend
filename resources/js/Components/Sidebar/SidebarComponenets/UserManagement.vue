<template>
  <label class="text-text-neutral-primary flex py-1.5 pl-3 text-sm font-semibold leading-6">User Management</label>
  <ul class="border-box w-full pb-px">
    <li>
      <a href="#"
         class="flex items-center text-gray-900 rounded-lg hover:bg-gray-200 h-8 pr-2.5 text-lg pl-2.5 ">
    ...
    <li>
      <a href="#"
         class="flex items-center text-gray-900 rounded-lg hover:bg-gray-200 h-8 pr-2.5 text-lg pl-2.5 ">
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none">
          <path d="M16 11L17.6965 12.5268C19.239 13.9151 20.0103 14.6093 20.0103 15.5C20.0103 16.3907 19.239 17.0849 17.6965 18.4732L16 20" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>
          <path d="M8.00005 4.82959L6.30358 6.35641C4.76102 7.74471 3.98975 8.43886 3.98975 9.32959C3.98975 10.2203 4.76102 10.9145 6.30358 12.3028L8.00005 13.8296" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>
